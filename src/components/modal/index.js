...
import "./index.css";
import ModelLeftImg from "../../assets/images/b9e787988290e8ac02e4afa1e2a2c5c7.svg";
  ...
  return (
    <div className="modal-content">
      <div className="row-1">
        ...
        <h3 className="close-modal" onClick={() => props.modalClose()}>
          Close{"  "}
          <svg
            height="13"
          ...
          >
            <path
              ...
              strokeWidth="2"
              strokeLinecap="round"
              d="M1.515 1l12.97 12.97m0-12.97L1.515 13.97"
            ></path>
          </svg>
        </h3>
      </div>
      <div className="row-2">
        <div className="modal-left">
          ...
          <p>
            We still need a bit more info to set up
            <br />
            your personalized product demo
          </p>
          <img className="img" src={ModelLeftImg} />
        </div>
        <div className="modal-right">
          ...
          <form className="form">
            ...
            <input type="text" placeholder="Delarship Name" />
